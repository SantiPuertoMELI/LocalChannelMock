...
func BuildCaptureOkResponse() CaptureResponse {
	return setupCaptureOkResponse()
}

func setupCaptureOkFields() map[int]iso8583_models.ISO8583MessageField {
...
func setupCaptureOkResponse() CaptureResponse {
	authISO8583Message := iso8583_models.ISO8583Message{
		Packaging: "iso87B",
		Fields:    setupCaptureOkFields(),
	}
