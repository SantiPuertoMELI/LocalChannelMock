...
func BuildRefundOkResponse() RefundResponse {
	return setupRefundOkResponse()
}

func setupRefundOkFields() map[int]iso8583_models.ISO8583MessageField {
	...
	authISO8583MessageFields[15] = iso8583_models.ISO8583MessageField{
		Encoding: iso8583_models.ISO8583FieldTypeString,
		Content:  time.Now().Format("0102"),
	}
	// Capture date MMDD
	...
	authISO8583MessageFields[38] = iso8583_models.ISO8583MessageField{
		Encoding: iso8583_models.ISO8583FieldTypeString,
		Content:  "123456",
	}
	// Response code
...
func setupRefundOkResponse() RefundResponse {
	authISO8583Message := iso8583_models.ISO8583Message{
		Packaging: "iso87B",
		Fields:    setupRefundOkFields(),
	}
	...
	refund := channel_iso8583.ChannelResponse{
		Success:        true,
